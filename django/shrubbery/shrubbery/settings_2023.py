...
if os.environ.get('SHRUBBERY_ENV') == 'prd':
    ALLOWED_HOSTS = ['multi2023.py-fmi.org', '2023.shrubbery-rnmp.onrender.com', 'shrubbery-rnmp.onrender.com']
    CSRF_TRUSTED_ORIGINS = ['https://multi2023.py-fmi.org', 'https://2023.shrubbery-rnmp.onrender.com', 'https://shrubbery-rnmp.onrender.com']
else:
    ALLOWED_HOSTS = ['*']
